...
export default function Container() {
    ...
    const slideLeftTransition = useTransition(location, {
        ...
        leave: { position: "absolute", opacity: 0, transform: "translate3d(-60%, 0, 0)"},
        config: { duration: 600, easing: easings.easeInOutCubic },
    });

    return (
        <div>
            <div style={{ maxWidth: "99vw" }} className="d-flex flex-column flex-lg-row justify-content-between">
                <Header />
